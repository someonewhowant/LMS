...
class CreateAchievementDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, description: { required: true, type: () => String }, iconUrl: { required: false, type: () => String }, criteria: { required: true, type: () => String }, points: { required: false, type: () => Number } };
    }
}
exports.CreateAchievementDto = CreateAchievementDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'First Blood' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateAchievementDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Complete your first course' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'COMPLETE_FIRST_COURSE' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
